...
- [maestro/](maestro/): Maestro (MusicCoach) coach — product PRD, agent architecture, and build-flow/prep. The forward-looking coach the app baseline defers to "a later PRD."
